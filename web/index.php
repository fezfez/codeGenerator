...
if (!is_dir($cacheDir) || !is_writable($cacheDir)) {
    ...
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="' . ((!is_file(__DIR__ . '/../vendor/autoload.php')) ? './../fezfez/code-generator/web/' : '' ) . '/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="' . ((!is_file(__DIR__ . '/../vendor/autoload.php')) ? './../fezfez/code-generator/web/' : '' ) . '/assets/css/styles.css">
